...
export default function FlavorCard({ title, desc, img, tags = [], priority = false }) {
    return (
        <div className="group flex flex-col bg-white rounded-custom overflow-hidden shadow-sm border border-chocolate/5 hover:scale-[1.03] transition-transform transition-shadow duration-300">
