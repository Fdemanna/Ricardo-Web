    ...
    return (
        <section className="pb-12 section-container grid md:grid-cols-2 gap-6">
            {LOCATIONS_DATA.map((loc, idx) => (
                ...
                <button onClick={() => navigate('/locations')} className="w-full text-left h-full group bg-[#FFFBF2] p-8 rounded-custom border border-chocolate/10 hover:border-chocolate/30 transition active:scale-95 cursor-pointer shadow-sm hover:shadow-md flex items-center justify-between">
                    <div>
                    ...
                    <div className="h-10 w-10 shrink-0 rounded-full bg-glacier flex items-center justify-center group-hover:bg-chocolate transition-colors">
